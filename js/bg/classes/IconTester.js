...
IconTester.prototype = {
    ...
    onTestIconsFinished: function (a) {
        ...
        }), savePageTreeToLocalStorage(tree,
            "pageTree", !0), savePageTreeToLocalStorage(recentlyClosedTree, "recentlyClosedTree", !0), this.badNodesFound.push(a), this.doTestIcons(this.onTestIconsFinished)) : (this.destroyTestIconsPage(), setTimeout(function () {
