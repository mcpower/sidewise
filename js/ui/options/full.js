...
function postInit() {
    ...
    $(document).on("click", "#closeButton", onCloseButtonClick).on("click", "#resetButton", resetAllSettings).on("click", "#detectMonitorsButton", detectMonitors).on("click", "#submitBugReportButton", submitBugReport).on("click",
        "#exportButton", exportState).on("click", "#importButton", importState).on("click", "#recoverLastSessionButton", restoreFromPreviousSessionBackup).on("click", "#panePickerExpander", showPanePicker);
